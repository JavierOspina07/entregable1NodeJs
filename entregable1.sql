...
INSERT INTO users (name, email, password, age, rol_id) VALUES ('Javier', 'javier@gmail.com', 1234, 31, 1);
...
/* ===== COURSES ===== */
INSERT INTO courses (description, title, level_course_id, teacher, category_id) VALUES ('basic JS concepts', 'JavaScript', 1, 2, 1);

INSERT INTO courses (description, title, level_course_id, teacher, category_id) VALUES ('operation of Framworks', 'React', 2, 3, 1);

INSERT INTO courses (description, title, level_course_id, teacher, category_id) VALUES ('joins management', 'NodeJs', 3, 4, 2);


/* ===== COURSE_VIDEO ===== */
INSERT INTO course_videos (title, url, course_id) VALUES ('introductory JS', 'acedemlo.com/video1', 1);

INSERT INTO course_videos (title, url, course_id) VALUES ('JS fixes', 'acedemlo.com/video2', 1);

INSERT INTO course_videos (title, url, course_id) VALUES ('introduction to react', 'acedemlo.com/react/video1', 2);

INSERT INTO course_videos (title, url, course_id) VALUES ('useState', 'acedemlo.com/react/video2', 2);

INSERT INTO course_videos (title, url, course_id) VALUES ('sql shell', 'acedemlo.com/NodeJs/video1', 3);

INSERT INTO course_videos (title, url, course_id) VALUES ('NodeJS', 'acedemlo.com/NodeJs/video2', 3);
